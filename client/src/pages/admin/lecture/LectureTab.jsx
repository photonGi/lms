...
import { useEditLectureMutation, useGetCourseByIdQuery, useRemoveLectureMutation, } from '@/features/api/courseApi'
...
const LectureTab = () => {
    ...
    const editLectureHandler = async () => {
        ...
        await editLecture({
            ...
            isPreviewFree: isFree, courseid, lectureId
        })
    }
        ...
        <Card>
            ...
            <CardContent>
                <div>
                    ...
                    <Input
                        type="text"
                        vlaue={lectureTitle} onChange={(e) => setLectureTitle(e.target.vlaue)}
