    ...
    <div className="relative bg-gradient-to-r from-blue-500 to bg-indigo-600 dark:to-gray-900 py-16 px-6 text-center mt-[4rem]">
      <div className="max-w-3xl mx-auto">
        ...
        <form onSubmit={searchHandler} className="flex">
          ...
          />
          <Button type="submit" className="dark:bg-gray-700 text-white px-6 py-6 rounded-r-full hover:bg-gray-700 duration-300">
            <Search /> Search
          </Button>
        </form>

        <Button onClick={() =>navigate(`/course/search?query`)} className="bg-white text-blue-600 font-bold absolute bottom-[-7%] left-[50%] -translate-x-1/2 transform z-8 rounded-full shadow-lg py-6 px-10 duration-300 hover:bg-slate-100">
