...
const Profile = () => {
    ...
    return (
        <div className='max-w-4xl mx-auto px-4 my-24'>
            <h1 className='font-bold rext-2xl text-center md:text-left'>PROFILE</h1>
            <div className='flex flex-col md:flex-row items-center md:items-start gap-8 my-5'>
                ...
                <div>
                    <div className='mb-2'>
                        <h1 className='font-semibold text-gray-900 dark:gray-100'>
                            Name:
                    ...
                    <Dialog>
                        ...
                        <DialogContent>
                            ...
                            <DialogDescription>
                                Make change your profile here. Click save when you're done.
                            </DialogDescription>
                            <div className='grid gap-4 py-4'>
                                ...
                                <div className='gird grid-cols-4 items-center gap-4'>
                                    ...
                                    <input onChange={onChangeHandler}
                                        type='file' accept='image/*' className='cols-span-3' />
                                </div>
                            </div>
                        </DialogContent>
                        <DialogFooter>
