...
export const editCourse = async () => {
  try {
    ...
    const { courseTitle, subTitle, description, category, courseLavel, coursePrice } = req.body;
    ...
    // update
    const updateData = { courseTitle, subTitle, description, category, courseLavel, coursePrice, courseThumbnail: courseThumbnail?.secure_url };
...
// publish unpublic course locgic
export const togglePubishCourse = async (req, res) => {
  ...
  try {
    ...
    await course.save();
    const statusMessage = course.isPublished ? "Published" : "Unpublishg";
    return res.status(200).json({
